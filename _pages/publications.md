...
* <span style="color:Black"> Electoral Accountability and Abuse of Law: Evidence from Public Procurement
	*(with [Serkant Adiguzel](https://serkantadiguzel.com/) and [Murat Koyuncu](https://academics.boun.edu.tr/mkoyuncu/))* </span>
	
	<font size="2.5"> Due to their distorted incentives such as rent-extraction, public officials are typically in imperfect compliance with the laws they are subject to. A variety of policies and tools have been put into force to curb such distorted incentives and their adverse effects especially regarding the use of public funds. In this paper, we investigate whether electoral accountability limits law abuse by public officials. Specifically, we compare the state contracts granted by elected mayors with those granted by appointed mayors in terms of \textit{law abuse} and \textit{contract terms} using a staggered Differences-in-Differences (DiD) design. Our findings indicate that appointed mayors are 23% more likely than elected mayors to abuse an \textit{unforeseen events clause} of the procurement law to expand their discretion in contract awarding. We show that such expanded discretion raises contract prices by 23% and lowers rebate values by 10%. In financial terms, $95 million could have been saved had the contracts been awarded by mayors with reelection incentives. </font> 	
