...
1. <span style="color:Black; font-size: 14px;"> Unforeseen Events or Unscrupulous Officials? Electoral Accountability and Law Abuse in Public Procurement *(with [Serkant Adiguzel](https://serkantadiguzel.com/) and [Murat Koyuncu](https://academics.boun.edu.tr/mkoyuncu/))* </span> <br>
	[Draft available soon](){: .btn--research}{:target="_blank"} <br>
	
	<span style="color:Black; text-align: justify; font-size: 13px; display: inline-block; width: 75%;"> <b>Abstract:</b> This paper investigates the role of electoral accountability in deterring public officials from legal transgressions, utilizing a novel measure of law abuse. Our primary focus is the undue exploitation of the unforeseen event clause, a standard provision in procurement regulations that offers officials greater discretion during force majeure incidents. Using a setting where elected mayors were replaced with appointed mayors combined with a staggered Differences-in-Differences (DiD) approach, our findings reveal that appointed mayors without reelection incentives are 24 percentage-points more likely to misuse the unforeseen event clause compared to elected mayors. Such misuse correspondingly inflates contract prices by 23% and diminishes value for money by 40%. These findings are robust to a variety of tests, including a Regression Discontinuity in Time (RDiT) approach. We rule out the possibility that the documented effects stem from better quality procurement due to expanded discretion. However, we find no evidence of electoral accountability deterring more subtle malpractices such as cost manipulation. </span> <br>
...
4. <span style="color:Black; font-size: 14px;"> Class Voting and Economic Policy Preferences: A Machine Learning Approach </span> <br>
